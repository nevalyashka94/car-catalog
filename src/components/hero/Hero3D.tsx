...
export default function Hero3D() {
  ...
  return (
    ...
    >
      {/* 3D-ТРАНСФОРМИРУЕМЫЙ КОНТЕЙНЕР СЦЕНЫ */}
      <div
      ...
      >
        ...
        {/* МАССИВНАЯ ТИПОГРАФИКА KAGE-STYLE НА ЗАДНЕМ ПЛАНЕ */}
        <div
          className="
            pointer-events-none
            absolute
        ...
        {/* НЕОНОВЫЙ ОРЕОЛ СВЕТА ФАР В ТЕМНОЙ ТЕМЕ */}
        <div
          className="
            pointer-events-none
            absolute
      ...
      {/* ОСНОВНОЙ КОНТЕНТ ПОВЕРХ 3D-СЦЕНЫ */}
      <div className="relative z-10 flex min-h-[640px] flex-col justify-between p-8 sm:p-12 lg:p-14">
        ...
        {/* ЦЕНТРАЛЬНО-НИЖНИЙ БЛОК: ЗАГОЛОВОК, КНОПКИ, ТАБЫ 01..04 */}
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-end">
          
          {/* Текстовый блок и кнопки */}
          ...
          {/* НАВИГАЦИОННЫЕ ТАБЫ В СТИЛЕ KAGE (01 / 02 / 03 / 04) */}
